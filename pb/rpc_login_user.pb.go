...
type LoginUserResponse struct {
	...
	AccessTokenExpiresAt  *Timestamp `protobuf:"bytes,5,opt,name=access_token_expires_at,json=accessTokenExpiresAt,proto3" json:"access_token_expires_at,omitempty"`
	RefreshTokenExpiresAt *Timestamp `protobuf:"bytes,6,opt,name=refresh_token_expires_at,json=refreshTokenExpiresAt,proto3" json:"refresh_token_expires_at,omitempty"`
}
...
func (x *LoginUserResponse) GetAccessTokenExpiresAt() *Timestamp {
	if x != nil {
...
func (x *LoginUserResponse) GetRefreshTokenExpiresAt() *Timestamp {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x22, 0xa6, 0x02, 0x0a, 0x11, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73, 0x65,
	...
	,
...
var file_rpc_login_user_proto_goTypes = []interface{}{
	...
	(*User)(nil),              // 2: pb.User
	(*Timestamp)(nil),         // 3: pb.Timestamp
}
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserResponse.user:type_name -> pb.User
	3, // 1: pb.LoginUserResponse.access_token_expires_at:type_name -> pb.Timestamp
	3, // 2: pb.LoginUserResponse.refresh_token_expires_at:type_name -> pb.Timestamp
